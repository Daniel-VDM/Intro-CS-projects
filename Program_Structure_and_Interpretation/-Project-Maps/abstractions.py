...
def make_restaurant(name, location, categories, price, reviews):
    ...
    return [name, location, categories, price, 
            # Not sure if I need boolean check, but it makes sure all reviews are for the restaurant.
            [review_rating(x) for x in reviews if name == review_restaurant_name(x)]]
    # END Question 2
