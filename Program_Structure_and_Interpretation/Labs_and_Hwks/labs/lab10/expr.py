...
class Name(Expr):
    ...
    def eval(self, env):
        ...
        # If concerned with efficiency, you could use the get method on dict 
        # and raise an error if key is default since Try/Catch is slow. 
        except KeyError:     
            raise NameError('Name',self.string,'is not found')
